...
```{r CCL-histo, echo=FALSE, fig.cap="x", fig.align = 'center'}
knitr::include_graphics("../figures/01_CCL_histogram.png")
```
Regarding the relationship between developmental stage and the tumor affliction, the null model poorly explained the variation on the CCL compared to the model with the tumor affliction. The better fitted model showed a significant difference between the mean CCL in green turtles afflicted by tumors and those non-afflicted. In general, green turtles afflicted by tumors (mean CCL = 41.2 cm; sd = 5.9 cm) are larger than the non-afflicted ones (mean CCL = 38.6 cm; sd = 6.4) (Figure 2).

```{r tumor-boxp, echo=FALSE, fig.cap="x", fig.align = 'center'}
